...
//     try {
//       const [timesheets, statusDb] = await Promise.all([
//         getAllTimesheets(),
//         getAllStatuses(),
//       ]);

//       const statusMap = buildStatusMap(statusDb);
...
//         item.time,
//         item.totalWork,
//         statusMap[item.status]?.join(", ") || "", // 👈 lookup instead of calling a function
//       ]);
...
//   const buildStatusMap = (statusArray) => {
//     const map = {};
//     statusArray.forEach((item) => {
//       if (!map[item.mainStatus]) {
//         map[item.mainStatus] = [];
//       }
//       map[item.mainStatus].push(item.subStatus);
//     });
//     return map;
//   };
