...
const E_Ticket = () => {
  ...
  const [filterValues, setFilterValues] = useState({
    project: "",
    category: "", // Keep in state, but remove from UI if not needed for filtering
    mainStatus: "",
    subStatus: "", // Keep in state, but remove from UI if not needed for filtering
    assignee: "", // Keep in state, but remove from UI if not needed for filtering
    priority: "",
    fromDate: "",
    toDate: "",
  });
  ...
  const applyFilters = (ticket) => {
    const { project, mainStatus, priority, fromDate, toDate } = filterValues;
          ...
          {filtersOpen && (
            ...
            >
              ...
              <Grid container spacing={2}>
                {["project", "mainStatus", "priority"].map((key) => (
